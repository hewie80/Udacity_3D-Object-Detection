...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            detections=decode(configs.num_classes,configs.num_center_offset,configs.num_direction,configs.num_z,configs.num_dim,configs.k)
            ret=post_processing(detections,configs)
