...
model_name='darknet' # Options are "fpn_resnet" and "darknet"
sequence='1' # Options are "1","2","3"
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results',model_name,'results_sequence_'+sequence+'_darknet')
